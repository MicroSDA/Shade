...
TestLayer::TestLayer(const std::string& name, se::Scene* scene) : se::ImGuiLayer(name, scene)
{
}
...
void TestLayer::OnDelete()
{

}

void TestLayer::ShowMainMenu(const bool& show)
{
	if (show)
	{
...
void TestLayer::ShowProjectBar(const bool& show)
{
	if (show)
	{
...
void TestLayer::ShowSceneWindow(const bool& show)
{
	if (show)
	{
...
void TestLayer::DrawEntity(se::Entity& entity, se::Entity& selectedEntity, const std::string& filter)
{
...
void TestLayer::DrawInspector(se::Entity& entity)
{
...
void TestLayer::DrawAddComponentDelteEntity(se::Entity& entity)
{
	if (ImGui::BeginPopupContextItem())
	{
...
void TestLayer::TagCallback(se::Entity& entity)
{
...
void TestLayer::Transform3DCallback(se::Entity& entity)
{
...
void TestLayer::Model3DCallback(se::Entity& entity)
{
...
bool TestLayer::DrawFloatVec3(const char* lable, float* data, const float& reset, const float& min, const float& max, const float& cw1)
{
	bool isUsed = false;
...
bool TestLayer::DrawFloat(const char* lable, float* data, const float& reset, const float& min, const float& max, const float& cw1, const float& cw2)
{
	ImGui::PushID(lable);
	ImGui::Columns(2);
	ImGui::SetColumnWidth(0, cw1);
